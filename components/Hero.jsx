  ...
  return (
    ...
    <div className="hero-content text-center">
      <div className="max-w-xl">
        <h1 className="text-6xl font-bold max-md:text-4xl text-accent-content">Jammu & Kashmir</h1>
        <p className="py-6 text-2xl max-md:text-lg text-accent-content">
        Where the majestic Himalayas meet enchanting valleys, creating a land of unparalleled beauty.
        </p>
